...
This check matters before construction because coordination problems can be found in the building model instead of on site.
...
The local command-line calls use the same backend as the MCP tools. The report command is listed in Section 9.
